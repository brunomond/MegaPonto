    ...
    return MaterialApp(
      ...
      theme: ThemeData(
          ...
          inputDecorationTheme: InputDecorationTheme(
            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(32), borderSide: BorderSide(color: Color.fromRGBO(140, 32, 55, 1))),
            hoverColor: Color.fromRGBO(140, 32, 55, 1),
            hintStyle: TextStyle(color: Colors.grey, fontFamily: 'Segoe UI', textBaseline: TextBaseline.alphabetic),
          ...
          textTheme: TextTheme(
            button: TextStyle(
                color: Colors.white, fontSize: 20, fontFamily: 'Segoe UI', fontWeight: FontWeight.bold),
            bodyText1: TextStyle(
                color: Colors.black87, fontSize: 28, fontFamily: 'Segoe UI'),
            bodyText2: TextStyle(
                color: Colors.black87, fontSize: 16, fontFamily: 'Segoe UI'),
            overline: TextStyle(color: Colors.grey, fontSize: 13, letterSpacing: -0.5, wordSpacing: 0),
            headline3: TextStyle(
              color: Colors.white, fontFamily: 'Cookie'
            )
          )),
    );
  }
